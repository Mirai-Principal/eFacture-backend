...
from Schemas.AnexoGatosPersonalesSchema import AgpDatosConsulta, AgpDatos
...
@router.get('/generar_agp/{identificacion_comprador}/{cod_periodo_fiscal}', response_model=List[AgpDatos])
def generar_agp(identificacion_comprador : str, cod_periodo_fiscal: int, db : Session = Depends(DataBase.get_db)):
    return AgpLogica.generar_agp(identificacion_comprador, cod_periodo_fiscal, db)
